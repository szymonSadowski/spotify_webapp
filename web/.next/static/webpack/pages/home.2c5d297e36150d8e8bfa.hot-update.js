...
var Home = function Home() {
  ...
  if (typeof tokenCode == "string") {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default.a.get("localhost:8080/podcast?access_token=".concat(tokenCode)).then(function (res) {
      console.log(res);
    });
